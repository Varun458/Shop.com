        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button className="lg:mt-2 xl:mt-0 flex-shrink-0 bg-gray-800 text-zinc-100 border-0 py-2 px-6 focus:outline-none hover:bg-zinc-500 hover:text-white rounded mx-auto flex">Submit</button>
              </div>
